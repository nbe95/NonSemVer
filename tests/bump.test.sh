...
assert_eq "$($CMD --bump-bugfix 12.34.5699 &> /dev/null)$?" "3" "Version limit"
...
assert_eq "$($CMD --bump-bugfix "69.00.0000"  )" "69.$cy.0100" "Version bump"
assert_eq "$($CMD --bump-bugfix "99.$py.9999" )" "99.$cy.0100" "Version bump"
assert_eq "$($CMD --bump-bugfix "01.$ny.2468" )" "01.$ny.2469" "Version bump"
...
assert_eq "$($CMD --bump-bugfix "00.$cy.0000" )" "00.$cy.0001" "Version bump"
assert_eq "$($CMD --bump-bugfix "12.$cy.3456" )" "12.$cy.3457" "Version bump"
assert_eq "$($CMD --bump-bugfix "78.$cy.9012" )" "78.$cy.9013" "Version bump"
