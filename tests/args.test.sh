...
assert_eq "$($NONSEMVER 1234567812345       &>/dev/null)$?" "2"     "Exit code 2 for invalid argument 9"
assert_eq "$($NONSEMVER 12.34.5678-12345    &>/dev/null)$?" "2"     "Exit code 2 for invalid argument 10"
